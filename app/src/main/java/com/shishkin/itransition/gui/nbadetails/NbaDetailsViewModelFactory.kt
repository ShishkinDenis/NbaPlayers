...
class NbaDetailsViewModelFactory @Inject constructor(var nbaPlayerRepository: NbaPlayerRepository, @NbaPlayerId var nbaPlayerId: Int?) : ViewModelProvider.Factory {
