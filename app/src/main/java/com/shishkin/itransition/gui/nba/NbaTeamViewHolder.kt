...
class NbaTeamViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(item: ListItem){
        val nbaTeam = item.item as? NbaTeam
            val teamFullName: String = itemView.context.getString(R.string.nba_team_full_name,nbaTeam?.fullName,nbaTeam?.abbreviation)
            val nbaTeamCity: String = itemView.context.getString(R.string.nba_team_city, nbaTeam?.city)
